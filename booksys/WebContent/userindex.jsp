...
<![endif]-->
    ...
    <body>
        <div id="wrap">
            ...
            <div class="leftMeun" id="leftMeun">
                <div id="logoDiv">
                    <p id="logoP"><img id="logo" alt="图书管理系统" src="images/logo.png"><span>图书管理系统</span></p>
                </div>
                <div id="personInfor">
                    <p id="userName" class="loginName">姓名</p>
                    <p>
                        <a>退出登录</a>
                    </p>
                </div>
                <div class="meun-title">账号管理</div>
                <div class="meun-item meun-item-active" href="#sour" aria-controls="sour" role="tab" data-toggle="tab"><img src="images/icon_source.png">查找图书</div>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="sour">
                      <!--  <div class="check-div form-inline">
                            <button class="btn btn-yellow btn-xs" data-toggle="modal" data-target="#addSource">添加图书</button>
                        </div> -->
												<div class="check-div form-inline">
														<div class="col-xs-3">
																<button class="btn btn-yellow btn-xs" data-toggle="modal" data-target="#addSource">添加图书 </button>
														...
														<div class="col-xs-4">
																...
																<button class="btn btn-white btn-xs "><a href="UserServlet">查 询 </a></button>
														</div>
												</div>
                        <!--<div class="data-div">
	...
	<tr>
		<td>${p.name}</td>
		<td>${p.description}</td>
		<td><img src="images/${p.listimg}" width="150" height="100"/></td>
		<td>${p.price}</td>
		<td>${p.discountprice}</td>
		<td><a href="editProduct?id=${p.id }">添加</a><br/>
		<a href="deleteProduct?id=${p.id}">删除</a>
		</td>
	</tr>
	</c:forEach>
	
</table>-->	<div class="data-div">
                    <div class="row tableHeader">
                        <div class="col-xs-2 ">
                           序号
                        </div>
                    ...
                    <div class="tablebody">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#reviseUser">添加</button>
                            </div>
                        </div>
                                        ...
                                        <div class="container-fluid">
                                            <form class="form-horizontal">
                                                <div class="form-group ">
                                                    <label for="sName" class="col-xs-3 control-label" class="bookName">图书名称：</label>
                                                    <div class="col-xs-8 ">
            ...
            <div role="tabpanel" class="tab-pane" id="user">
                <div class="check-div form-inline">
                    <div class="col-xs-3">
                        <button class="btn btn-yellow btn-xs" data-toggle="modal" data-target="#addUser">添加图书 </button>
                    </div>
                    <div class="col-xs-4">
                        <input type="text" class="form-control input-sm" placeholder="输入文字搜索">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <form class="form-horizontal">
                                        <div class="form-group ">
                                            <label for="sName" class="col-xs-3 control-label">用户：</label>
                                            <div class="col-xs-8 ">
                                                <input type="email" class="form-control input-sm duiqi" id="sName" placeholder="">
                                            </div>
                                        </div>
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group text-right">
                            <div class="col-xs-offset-4 col-xs-5" style="margin-left: 169px;">
                                ...
                                <button type="submit" class="btn btn-xs btn-green"><a href="login.jsp">保存</a></button>
                            </div>
                        </div>
                    </form>
                </div>
